...
final class CustomSwipeProgressBar {
    ...
    private final static int COLOR1 = android.graphics.Color.BLACK;
    private final static int COLOR2 = android.graphics.Color.WHITE;
    private final static int COLOR3 = android.graphics.Color.BLACK;
    private final static int COLOR4 = android.graphics.Color.WHITE;
     ...
     */
    void setColorScheme(Object color1, Object color2, Object color3, Object color4) {
        mColor1 = (int) color1;
        mColor2 = (int) color2;
        mColor3 = (int) color3;
        mColor4 = (int)color4;

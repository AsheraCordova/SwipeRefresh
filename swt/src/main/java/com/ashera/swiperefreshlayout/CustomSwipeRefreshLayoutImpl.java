...
public java.util.Map<String, Object> getOnRefreshEventObj( ) {
	...
	public int getStyle(int initStyle, Map<String, Object> params, IFragment fragment) {
		...
		//end - body
	private static final class MouseListener implements org.eclipse.swt.widgets.Listener {
		private MotionEvent event = new MotionEvent();
		private int action;
		private com.reginald.swiperefresh.CustomSwipeRefreshLayout customSwipeRefreshLayout;
		public MouseListener(com.reginald.swiperefresh.CustomSwipeRefreshLayout customSwipeRefreshLayout) {
		...
		public void handleEvent(org.eclipse.swt.widgets.Event event) {
			...
			case org.eclipse.swt.SWT.MouseMove:
				if (action == 1) {
					processTouchEvent(MotionEvent.ACTION_MOVE, x, y);
				}
				break;
		...
		private void processTouchEvent(int action, int x, int y) {
			...
			this.customSwipeRefreshLayout.onInterceptTouchEvent(event);
	...
	public void initialized() {
		super.initialized();
		MouseListener listener = new MouseListener(customSwipeRefreshLayout);
		org.eclipse.swt.widgets.Composite composite = ((org.eclipse.swt.widgets.Composite)pane);
